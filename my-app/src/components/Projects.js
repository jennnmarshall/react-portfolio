  ...
  return (
    <main id="projects" className="main">
      <section className="card-prime">
        <img src={boozehound} alt="A cartoon dog having a beverage." />
      ...
      <section className="card">
        <img src={kermit} alt="Kermit hangman" />
        <div className="card-tag">
      ...
      <section className="card">
        <img src={nick} alt="A portrait of Nick Cave in black and white." />
        <div className="card-tag">
          <a href="#">
            <h3>Coming Soon.</h3>
            <p>(tm)</p>
      ...
      <section className="card">
        <img src={skittle} alt="A portrait of Jensen Ackles in Skittles." />
        <div className="card-tag">
          <a href="#">
            <h3>Coming Soon.</h3>
            <p>(tm)</p>
      ...
      <section className="card">
        <img src={lentil} alt="A portrait of Chris Hardwick in lentils." />
        <div className="card-tag">
          <a href="#">
            <h3>Coming Soon.</h3>
            <p>(tm)</p>
